...
public class SearchPanel extends HorizontalPanel implements /*ClickHandler, */KeyUpHandler{
	...
	public SearchPanel(ClickHandler clickHandler, String waterMark, String primaryName) {
		super();
		searchTextBox = new WatermarkedTextBox();
		searchTextBox.setWatermark(waterMark);
		searchButton = new Button();
		searchButton.setStylePrimaryName(primaryName);
...
//	}
	...
	public WatermarkedTextBox getSearchTextBox() {
