...
import org.rebioma.client.WaterMarkedComboBox;
...
public class AdvancedComboBoxExample{
  ...
  interface ExampleTemplate extends XTemplates {
    @XTemplate("<div class='{style.searchItem}'><h3>{post.title}</h3>{post.text}</div>")
  ...
  public interface Forum {
    @PropertyName("es_field")
    public String getTitle();

    @PropertyName("occ_id")
    public String getTopicId();

    @PropertyName("es_value")
  ...
  private WaterMarkedComboBox<Forum> combo;
...
//      String url = "http://www.sencha.com/forum/topics-remote.php";
      String url = GWT.getModuleBaseURL() + "globalsearch";
//      String url = "file:///K:/_Projets/Rebioma/workspace/RebiomaAdvancedSearch/src/net/rebioma/data/client/forms/forum.json";
      ...
      combo = new WaterMarkedComboBox<Forum>(cell);
      combo.setStylePrimaryName("rebioma-txtinput");
      combo.getElement().addClassName("search-panel-textbox");
      combo.getListView().setWidth(500);
      combo.setLoader(loader);
      combo.setWidth("100%");
      combo.setHideTrigger(true);
      combo.setPageSize(10);
      combo.setHeight("100%");
      combo.setBorders(false);
