...
public class StatisticsPanel  extends Widget{
	...
	public Widget statisticsPanel(String gridTitle) {
		...
		final SimpleComboBox<String> type = new SimpleComboBox<String>(new StringLabelProvider<String>());
		...
		final TextButton details  = new TextButton("Show details");
		details.addStyleName("text");

		toolBarHaut.add(new FillToolItem());
		toolBarHaut.add(details);
		details.setEnabled(false);
		toolBarHaut.add(new HTML("&nbsp;&nbsp;"));
		...
		type.addSelectionHandler(new SelectionHandler<String>() {
			...
			public void onSelection(SelectionEvent<String> arg0) {
				...
				type.setValue(arg0.getSelectedItem());
		...
		selectionModel.addSelectionChangedHandler(new SelectionChangedHandler<StatisticModel>() {

			@Override
			public void onSelectionChanged(
					SelectionChangedEvent<StatisticModel> event) {
