...
public class BaseUploadStatus implements IUploadStatus {
  ...
  public class BasicProgressBar extends FlowPanel implements HasProgress {
    ...
    public BasicProgressBar() {
      ...
      this.setStyleName("progress-bar green shine stripes");
      this.add(statusBar);
      this.add(statusMsg);
    ...
    public void setProgress(int done, int total) {
      ...
      statusBar.setWidth(2*percent + "px");
  ...
  protected Label tacheLabel = getTacheLabel();
  ...
  public BaseUploadStatus() {
    ...
    tacheLabel.setStyleName("tache");
    //tacheLabel.setText("Tache 1/2");
  ...
  public void setFileName(String name) {
	  ...
	  fileNameLabel.setText(names[0]);
	  try{		  
		  tacheLabel.setText(names[1]);
	  }catch(Exception er){}
  }
